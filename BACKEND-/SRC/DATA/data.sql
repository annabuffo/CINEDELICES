...
------------------------------------------------------------
--Table : public.recipe_has_film (association many to many)
------------------------------------------------------------
...
------------------------------------------------------------
--Table : public.discussion_has_film (association many to many)
------------------------------------------------------------

CREATE TABLE public.discussion_has_film (

    id_discussion INTEGER NOT NULL,
    id_film INTEGER NOT NULL,

    PRIMARY KEY (id_discussion, id_film),
